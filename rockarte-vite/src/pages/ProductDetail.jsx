...
const products = { 
    ...
    'floor-stone': [
       ...
       {id: 10, name: 'Sanchez palillo', image: '/imagenes-de-proyecto/sanchez/semirrustica_palillo.jpeg', price: '₡18,000', rating: 4.7, description: 'Una excelente opcion para paredes exteriores, muy resistente al agua.' },
        { id: 11, name: 'Lajón Negro', image: '/imagenes-de-proyecto/lajas/lajon_ducha.jpeg', price: '₡10,000', rating: 4.3, description: 'ideal para pisos exteriores, cerca de una piscina, etc, muy resistente al agua y al sol.' },
    ]
};
